...
app.post("/submit", (req, res) => {
  ...
  let bandFName = adj[Math.floor(Math.random() * adj.length)];
  let bandLName = noun[Math.floor(Math.random() * noun.length)];
  let bandName = bandFName + ' ' + bandLName;
  res.render('index.ejs',{
    title: bandName,
    pageTitle: `Your band name is: '${bandName}'` 
  })
});
